#ifndef CONFIG_BOARD_AC632N_NODE_CFG_H
#define CONFIG_BOARD_AC632N_NODE_CFG_H

#include "board_ac632n_target_node_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC632N_TARGET

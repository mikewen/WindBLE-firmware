#ifndef CONFIG_BOARD_AC632N_DISTRIBUTOR_GLOBAL_BUILD_CFG_H
#define CONFIG_BOARD_AC632N_DISTRIBUTOR_GLOBAL_BUILD_CFG_H

/* 改文件只添加和isd_config.ini相关的配置，用以生成isd_config.ini */
/* 其他不相关的配置请勿添加在改文件 */

#ifdef CONFIG_BOARD_AC632N_DISTRIBUTOR
...
#define CONFIG_RESERVED_AREA1					MESH
#ifdef CONFIG_RESERVED_AREA1
#define CONFIG_RESERVED_AREA1_ADDR			    AUTO
#define CONFIG_RESERVED_AREA1_LEN				0x3C000
#define CONFIG_RESERVED_AREA1_OPT				1
//#define CONFIG_RESERVED_AREA1_FILE				target_node_update.bin
#endif

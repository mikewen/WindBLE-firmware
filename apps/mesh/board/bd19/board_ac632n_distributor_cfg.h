#ifndef CONFIG_BOARD_AC632N_DISTRIBUTOR_H
#define CONFIG_BOARD_AC632N_DISTRIBUTOR_H

#include "board_ac632n_distributor_global_build_cfg.h"
...
#define TCFG_ADKEY_PORT                     IO_PORTB_04         //AD按键端口(需要注意选择的IO口是否支持AD功能)

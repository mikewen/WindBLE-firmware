#ifndef CONFIG_BOARD_AC638N_DEMO_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC638N_DEMO_POST_BUILD_CFG_H
...
#define CONFIG_CHIP_NAME                        AC638N              //除了SDK发布者,请不要修改
//it can be modified before first programming,but keep the same as the original version
#define CONFIG_PID                              AC638N              //烧写或强制升级之前可以修改,之后升级要保持一致
//it can be modified before first programming,but keep the same as the original version
